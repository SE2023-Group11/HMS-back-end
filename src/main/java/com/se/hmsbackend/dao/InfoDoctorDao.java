...
//    TODO:TESTing
    ...
    @Insert("INSERT INTO info_doctor (doctor_id, info_time, info_body) VALUES (#{doctorId}, #{infoTime}, #{infoBody})")
    @Options(useGeneratedKeys = true,keyProperty = "infoId")
    public void addInfo(InfoDoctor infoDoctor);

    @Update("UPDATE info_doctor SET doctor_id = #{doctorId}, info_time = #{infoTime}, info_body = #{infoBody} WHERE info_id = #{infoId}")
